...
*Tài liệu dựa trên: AGENTS.md (8-Stage Pipeline, Assurance Checklist), hooks-standardized.md (Antigravity IDE Hooks — Google), architecture-and-flow.md (Chrome Extension MV3/WXT).*
